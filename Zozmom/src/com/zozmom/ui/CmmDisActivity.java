...
public class CmmDisActivity extends BaseTaskActivity<Object> {
	String type;
	...
	public void requestByType() {
		...
		XHttp.Get(Constant.DIS + producttype, map,
	...
	class ListAdaper extends BaseTaskAdaper<ProductModel> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			int productArea = goodsModel.getProductArea();
