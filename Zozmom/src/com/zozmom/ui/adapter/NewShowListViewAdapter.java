 ...
 * 
 */
public class NewShowListViewAdapter extends BaseTaskAdaper<ShowModel> {

	public NewShowListViewAdapter(Context context, List<ShowModel> mDatas,PullToRefreshListView listview,PhotoLoader loader) {
