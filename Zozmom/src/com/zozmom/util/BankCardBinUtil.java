...
/**
 * @Description: BankCardBinUtil
 * @Author: vahoa.ma
 * @CreateTime: 2015-08-03 14:27
 */
public class BankCardBinUtil {
    ...
    private final static int[] bankBinArray = {102033, 103000, 185720, 303781,
            ...
            998800, 621226, 621558, 621661};
    // "发卡行.卡种名称",
    private static final String[] bankNameArray = {"广东发展银行.广发理财通", "农业银行.金穗借记卡",
            ...
            "沈阳市商业银行.玫瑰卡", "深圳农联社.信通卡", "D.F.S.I.发现卡", "D.F.S.I.发现卡",
            ...
            "大连商业银行.北方明珠卡", "大连商业银行.北方明珠卡", "河北省农村信用社.信通卡", "韩亚银行.借记卡",
            ...
            "江苏锡州农村商业银行.金阿福", "江苏锡州农村商业银行.金阿福", "南充市商业银行.熊猫团团卡",
            "南充市商业银行.熊猫团团卡", "长沙市商业银行.芙蓉贷记卡", "长沙市商业银行.芙蓉贷记卡",
            ...
            "上海浦东发展银行.东方卡", "深圳发展银行.发展卡", "工商银行.牡丹卡普卡", "工商银行.福农灵通卡",
            "中国银行.借记卡"};
     ...
     * @return
     */
//    public static String getBankName(String bankBin) {
//        Preconditions.checkNotNull(bankBin);
//        //处理卡号长度
//        if (bankBin.length() < 6) {
//            return null;
//        } else {
...
//        }
//        int bin = Integer.valueOf(bankBin);
//        int index = binarySearch(bankBinArray, bin);
//        if (index == -1 || index > bankNameArray.length) {
//            return null;
//        }
//        String fullBankName = bankNameArray[index] + "";
//        return Splitter.on(".").omitEmptyStrings().trimResults().splitToList(fullBankName).get(0);
//
//    }
